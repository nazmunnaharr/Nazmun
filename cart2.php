<?php
    ...
    $user_id=$_SESSION['id'];
    $user_products_query="select it.id,it.name,it.price from users_items ut inner join items2 it on it.id=ut.item_id where ut.user_id='$user_id'";
    ...
    <body>
        <div>
            ...
            <footer class="footer">
               <div class="container">
                <center>
                 <P>If Any problem Conrtect With Us in Email="emonalam46@gmail.com"</P></br>
                   <p>This website is developed by Naser/Mamun/Emon/Shuvecha</p>
               </center>
               </div>
           </footer>
        </div>
